    ...
    if(this.home == null) {
        ...
        for(var i = 0, length = scripts.length; i < length; i++) {
            ...
            if(src != null && src != undefined && src.length > 0) {
                var k = src.indexOf("/finder/media/index.js");
                if(k > -1) {
                    home = src.substring(0, k + "/finder/media/".length);
                    break;
                }
            }
        }
...
AudioPlayer.prototype.play = function(track) {
    ...
    this.icon = MediaUtil.getHome() + "/images/audio.gif";
...
VideoPlayer.prototype.getContent = function() {
    ...
    buffer[buffer.length] = "    <div class=\"loading\"><div class=\"loading-body\"><img src=\"?action=res&path=/finder/images/loading.gif\"/></div></div>";
    buffer[buffer.length] = "  </div>";
...
VideoPlayer.prototype.play = function(track) {
    ...
    this.title = item.title;
    this.icon = MediaUtil.getHome() + "/images/video.gif";
    TaskManager.setTitle(this);
