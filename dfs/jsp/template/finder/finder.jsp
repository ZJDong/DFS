...
<script type="text/javascript" src="?action=res&path=/finder/plugins.js"></script>
<script type="text/javascript" src="?action=res&path=/finder/lang/<%=i18n.getLang()%>.js"></script>
</head>
<body localIp="${localIp}" contextPath="${contextPath}" host="${host}" workspace="${workspace}" path="${path}">
<div class="finder" style="min-width: 960px;">
    ...
    <div id="file-view" class="detail-view">
        <div id="head-view" class="head">
            ...
            <span class="fileName orderable selected" orderBy="file-name" unselectable="on" onselectstart="return false;"><em class="title"><%=i18n.getString("finder.list.title.file-name")%></em><em class="order asc"></em></span>
...
<div id="finder-contextmenu" class="contextmenu" style="top: 50px; left: 100px; display: none;">
    <ul class="menu">
        ...
        <li class="item disabled" command="zip" unselectable="on">
            <span class="icon"><img src="?action=res&path=/finder/images/zip.gif"/></span>
            <a class="command" href="javascript:void(0)"><%=i18n.getString("finder.context-menu.zip")%>(Z)</a>
        </li>
        <li class="item disabled" command="unzip" unselectable="on">
            <span class="icon"><img src="?action=res&path=/finder/images/zip.gif"/></span>
            <a class="command" href="javascript:void(0)"><%=i18n.getString("finder.context-menu.unzip")%>(U)</a>
        </li>
        <li class="separator"></li>
        ...
        <li class="item" command="info" unselectable="on">
            <span class="icon"><img src="?action=res&path=/finder/images/info.gif"/></span>
...
<div id="pageContext" style="display: none;"
    mode="${mode}"
    text-type="<%=ConfigFactory.getTextType()%>"
    upload-part-size="<%=ConfigFactory.getUploadPartSize()%>"
    display-operate-button="<%=ConfigFactory.getOperateButton()%>"></div>
