...
public class GrepTemplate extends com.skin.finder.web.servlet.JspServlet {
    ...
    protected static final byte[] _jsp_string_9 = b("<script type=\"text/javascript\" src=\"?action=res&path=/finder/grep.js\"></script>\r\n");
    ...
    protected static final byte[] _jsp_string_39 = b("    <div class=\"find-panel\">\r\n        <div>\r\n            查找内容: <input id=\"grep-keyword\" type=\"text\" class=\"grep-keyword\" value=\"\" placeholder=\"正则示例: /finder/.*\\.html\"/>\r\n");
    protected static final byte[] _jsp_string_40 = b("            <input id=\"grep-ensure\" type=\"button\" class=\"grep-search\" value=\"查找\"/>\r\n");
    protected static final byte[] _jsp_string_41 = b("        </div>\r\n        <div style=\"clear: both; padding-top: 12px; height: 20px;\">\r\n");
    protected static final byte[] _jsp_string_42 = b("            <span style=\"float: left; width: 10px; display: inline-block;\"><input id=\"grep-regexp\" type=\"checkbox\" title=\"正则表达式\"/></span>\r\n");
    protected static final byte[] _jsp_string_43 = b("            <span style=\"float: left; margin-left: 6px; margin-top: -1px; width: 100px; display: inline-block;\">正则表达式</span>\r\n");
    protected static final byte[] _jsp_string_44 = b("        </div>\r\n        <div style=\"clear: both; margin-top: 10px;\">\r\n            <p><span style=\"color: #ff0000;\">提示：</span>快捷键(Ctrl + B)，再次按下可关闭。</p>\r\n");
    protected static final byte[] _jsp_string_45 = b("            <p><span style=\"color: #ff0000;\">参考：</span><a href=\"http://docs.oracle.com/javase/7/docs/api/java/util/regex/Pattern.html#sum\" target=\"_blank\">正则表达式参考</a></p>\r\n");
    protected static final byte[] _jsp_string_46 = b("        </div>\r\n        <div style=\"margin-top: 20px; text-align: center;\">\r\n            <input id=\"grep-close\" type=\"button\" class=\"grep-button\" value=\"关闭\"/>\r\n");
    protected static final byte[] _jsp_string_47 = b("        </div>\r\n    </div>\r\n</div>\r\n<!-- http://www.finderweb.net -->\r\n</body>\r\n");
    protected static final byte[] _jsp_string_48 = b("</html>\r\n");
