...
import com.skin.finder.security.Permission;
import com.skin.finder.security.PermissionManager;
import com.skin.finder.security.UserHostManager;
import com.skin.finder.security.UserPermission;
...
public class TreeServlet extends BaseServlet {
    ...
    public void tree(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException  {
