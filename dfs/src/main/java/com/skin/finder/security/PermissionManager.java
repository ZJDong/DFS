...
import com.skin.finder.security.command.Grant;
...
public class PermissionManager {
    ...
    /**
     * 赋权限: grant read on 192.168.1.1@finder.log/test/test.log to admin;
     * @param command
     */
    public void grant(String command) {
        Grant grant = Grant.parse(command);
        String userName = grant.getUserName();
//        String pattern = grant.getPattern();
//        String action = grant.getAction();
//        String workspace = grant.getPattern();
